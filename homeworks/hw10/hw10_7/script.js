...
function addToLocalStorage(arrayName, objToAdd) {
    ...
    try {
        ...
        console.error("Помилка під час парсингу JSON з localStorage:", error);
    }
}

const newUser = { id: 1, name: 'Олексій', role: 'admin' };
addToLocalStorage('usersList', newUser);
addToLocalStorage('usersList', { id: 2, name: 'Марія', role: 'user' });
